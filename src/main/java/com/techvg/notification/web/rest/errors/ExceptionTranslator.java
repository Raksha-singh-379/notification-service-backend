package com.techvg.notification.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.techvg.notification.service.EmailAlreadyUsedException ||
            ex instanceof com.techvg.notification.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.techvg.notification.service.InvalidPasswordException
